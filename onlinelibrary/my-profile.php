...
$sql="update tblstudents set FullName=:fname,Faculty=:faculty,MobileNumber=:mobileno where StudentId=:sid";
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <form name="signup" method="post">
                                <?php 
$sid=$_SESSION['stdid'];
$sql="SELECT StudentId,FullName,EmailId,Faculty,Department,Year,MobileNumber,RegDate,UpdationDate,Status from  tblstudents  where StudentId=:sid ";
$query = $dbh -> prepare($sql);
$query-> bindParam(':sid', $sid, PDO::PARAM_STR);
$query->execute();
...
{               ?>
  ...
  // echo $fac;
    ...
    if ($fac=="fas") {
    echo htmlentities("Faculty Of Applied Science");
    }
   else if($fac=="bms")
    {
        echo htmlentities("Faculty of Bussiness & Communication Studies");
    }
    
    else if($fac=="sidha"){
        echo htmlentities("Faculty of Sidha Medicine");
    }
