...
<head>
    ...
    <title>Online Library Management System | Manage Returned Books</title>
...
<body>
    <!------MENU SECTION START-->
    <?php include('includes/headerreturnedbook.php');?>
    <!-- MENU SECTION END-->
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Manage Returned Books</h4>
                </div>
                <div class="row">
